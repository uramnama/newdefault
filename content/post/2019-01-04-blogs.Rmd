...
This graph compares the area of houses and the frontage (width) of houses by the land contour
```{r point}
library(dplyr)
housing.filt %>% ggplot() + geom_point(aes(LotFrontage,LotArea,color=LotShape))
  theme_tufte()
